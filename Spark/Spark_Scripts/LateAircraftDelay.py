...
conf = (SparkConf().setAppName("LateAircraftDelay"))
...
if __name__ == "__main__":
    ...
    df2 = df1.withColumn("LateAircraftDelay",df1.LateAircraftDelay.cast('int'))
    df2.groupBy("Year").avg("LateAircraftDelay").show(truncate=False)
    sc.stop()
    spark.stop()
