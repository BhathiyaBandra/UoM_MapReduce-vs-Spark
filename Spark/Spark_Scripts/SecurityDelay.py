...
conf = (SparkConf().setAppName("SecurityDelay"))
...
if __name__ == "__main__":
    ...
    df2 = df1.withColumn("SecurityDelay",df1.SecurityDelay.cast('int'))
    df2.groupBy("Year").avg("SecurityDelay").show(truncate=False)
    sc.stop()
    spark.stop()
